...
import net.amishi.slimerancher.item.custom.eggs.PinkSlimeSpawnEgg;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> PINK_SLIME_SPAWN_EGG = ITEMS.register("pink_slime_spawn_egg", () -> new PinkSlimeSpawnEgg(ModEntityTypes.PINK_SLIME.get(), new Item.Properties().tab(ModCreativeTab.SLIME_RANCHER_TAB)));
