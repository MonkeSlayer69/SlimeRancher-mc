...
public class TigerBaseSlimeSpawnEgg extends BaseSlimeSpawnEgg {

    private static final String TOOLTIP_INFO = "tooltip.slimerancher.tiger_slime_spawn_egg";

    public TigerBaseSlimeSpawnEgg(EntityType<? extends Mob> pDefaultType, Properties pProperties) {
